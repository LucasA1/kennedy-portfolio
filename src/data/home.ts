import { MdAutoAwesome, MdCampaign, MdDesignServices, MdPalette } from 'react-icons/md'
import { FaLocationDot, FaSchool, FaUser } from 'react-icons/fa6'
...
export const homeContent: HomeContent = {
  ...
  about: {
    ...
    meta: [
      ...
      { icon: FaLocationDot, label: 'Des Moines, Iowa' },
      { icon: FaSchool, label: 'University of Iowa', sublabel: 'Graphic Design – B.F.A.' },
    ],
    paragraphs: [
